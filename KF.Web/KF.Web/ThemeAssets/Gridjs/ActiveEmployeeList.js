...
function Delete(e) {
    ...
    if (warningMsg == true) {
        ...
        var url = "/Kippin/DeleteEmployee?Id=REPLACEME";
...
function Activate(e) {
    ...
    if (warningMsg == true) {
        ...
        var url = "/Kippin/ActivateEmployee?Id=REPLACEME";
        window.location.href = url.replace('REPLACEME', e.data.id);
    }
    else {
        return false;
...
function Deactivate(e) {
    ...
    if (warningMsg == true) {
        ...
        var url = "/Kippin/DeactivateEmployee?Id=REPLACEME";
        window.location.href = url.replace('REPLACEME', e.data.id);
    }
    else {
        return false;
...
function editEmployee(e) {
    ...
    var url = "/Kippin/UpdateSubAccountant?id=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}
...
function SendMail(e) {
    //var url = "/Kippin/Finance/Kippin/SendEmployeeEmail?UserId=REPLACEME";
    var url = "/Kippin/SendEmployeeEmail?UserId=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}
