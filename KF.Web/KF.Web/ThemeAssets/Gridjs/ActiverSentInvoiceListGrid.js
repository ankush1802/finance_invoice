var ActiverSentInvoiceListGrid;
$(document).ready(function () {
    ActiverSentInvoiceListGrid = $("#ActiverSentInvoiceListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editPdf(e) {
    ...
    var col_index = 7;
    var IsCustomer = $('#ActiverSentInvoiceListGrid tr:eq(' + row_index + ') td:eq(' + col_index + ')').find("div").attr('title');
    var Id = e.data.id;

    $.ajax({
        url: 'http://52.27.249.143/Kippin/Finance/Invoice/ReceivedInvoicePdf/?id=' + Id + '&IsCustomer=' + IsCustomer,
        // url: '/Invoice/ReceivedInvoicePdf/',
...
function editEmployee(e) {
    ...
    if (e.data.Id1 == 0) {
        ...
        var url = "/Kippin/Finance/Invoice/EditSentInvoice?id=REPLACEME";
