var ActiverSupplierListGrid;
$(document).ready(function () {
    ActiverSupplierListGrid = $("#ActiverSupplierListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/UpdateSupplier?id=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}
function SendMailButton() {
    $("#ActiverSupplierListGrid tr").each(function () {
