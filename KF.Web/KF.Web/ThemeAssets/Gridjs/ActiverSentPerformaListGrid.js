var ActiverSentPerformaListGrid;
$(document).ready(function () {
    ActiverSentPerformaListGrid = $("#ActiverSentPerformaListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editPdf(e) {
    ...
    var col_index = 7;
    var IsCustomer = $('#ActiverSentPerformaListGrid tr:eq(' + row_index + ') td:eq(' + col_index + ')').find("div").attr('title');
    var Id = e.data.id;
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/EditSentProforma?id=REPLACEME";
