var ActiverReceivedPerformaListGrid;
$(document).ready(function () {
    ActiverReceivedPerformaListGrid = $("#ActiverReceivedPerformaListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editPdf(e) {
    ...
    var col_index = 7;
    var IsCustomer = $('#ActiverReceivedPerformaListGrid tr:eq(' + row_index + ') td:eq(' + col_index + ')').find("div").attr('title');
    var Id = e.data.id;
    $.ajax({
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/EditReceivedProforma?id=REPLACEME";
