var ActiverInvoiceSentPerformaListGrid;
$(document).ready(function () {
    ActiverInvoiceSentPerformaListGrid = $("#ActiverInvoiceSentPerformaListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editPdf(e) {
    ...
    var col_index = 7;
    var IsCustomer = $('#ActiverInvoiceSentPerformaListGrid tr:eq(' + row_index + ') td:eq(' + col_index + ')').find("div").attr('title');
    var Id = e.data.id;
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/EditInvoiceSentProforma?id=REPLACEME";
