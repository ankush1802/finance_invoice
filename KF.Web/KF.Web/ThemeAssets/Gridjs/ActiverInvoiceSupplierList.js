var ActiverInvoiceSupplierListGrid;
$(document).ready(function () {
    ActiverInvoiceSupplierListGrid = $("#ActiverInvoiceSupplierListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/InvoiceUpdateSupplier?id=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}
function SendMailButton() {
    $("#ActiverInvoiceSupplierListGrid tr").each(function () {
