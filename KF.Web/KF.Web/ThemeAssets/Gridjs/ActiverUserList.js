...
function SendMail(e) {
    var url = "/Kippin/Finance/Kippin/SendEmail?UserId=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}

function SelectUser(e) {
    /*Live*/
    // var url = "/Kippin/Finance/Kippin/SelectUser?UserId=REPLACEME";
    /*Local*/
    var url = "/Kippin/SelectUser?UserId=REPLACEME";
    window.location.href = url.replace('REPLACEME', e.data.id);
}
