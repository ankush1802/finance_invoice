var ActiverInvoiceReceivedPerformaListGrid;
$(document).ready(function () {
    ActiverInvoiceReceivedPerformaListGrid = $("#ActiverInvoiceReceivedPerformaListGrid").grid({
        dataKey: "Id",
        uiLibrary: "bootstrap",
        columns: [
...
function editPdf(e) {
    ...
    var col_index = 7;
    var IsCustomer = $('#ActiverInvoiceReceivedPerformaListGrid tr:eq(' + row_index + ') td:eq(' + col_index + ')').find("div").attr('title');
    var Id = e.data.id;
...
function editEmployee(e) {
    ...
    var url = "/Kippin/Finance/Invoice/EditInvoiceReceivedProforma?id=REPLACEME";
